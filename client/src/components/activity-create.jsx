...
const handlesearchcountryininputbutton = ()=>{
    for(let i= 0; i<country.length; i++){
        ...
        if(inputname.toLocaleLowerCase()=== country[i].toLocaleLowerCase()){
            return alert('Sorry your country has been loaded')
        }
    ...
    //LOGICA PARA NO PONER AL PAIS DOS VECES 
        //console.log(country)

    // FIN DE LOGICA PARA NO PONER AL PAIS DOS VECES 
    return (
        <div>
              <Link to='../countries'> 
